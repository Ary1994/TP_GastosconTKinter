...
def obtener_lista_gastos():
    ...
    try:
        ...
        for gasto in gastos:
            lista_gastos.insert(END, f"Nombre: {gasto[0]}, Cantidad: {gasto[1]}, Fecha: {gasto[2]}, Categoría: {gasto[3]}")
...
cuaderno1.add(pagina2, text="Resumen Gtos",compound= obtener_lista_gastos)
cuaderno1.add(pagina3, text="Editar Gtos")
cuaderno1.add(pagina4, text="Descargar ")

# Configurar la imagen de fondo en la pestaña 1
...
lista_gastos = Listbox(pagina2, bg='lightblue')
lista_gastos.pack()
